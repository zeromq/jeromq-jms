...
public class ZmqJMSContext implements JMSContext {
	...
	final ZmqConnection connection;
	final int sessionMode;
	final ZmqSession session;
	...
	@Override
	public JMSConsumer createSharedConsumer(final Topic topic, String name, final String messageSelector) {
	    checkSession();
